...
public class PostCommentProvider {
	 ...
	 * */
	public void update(PostComment oldPostComment, PostComment newPostComment) {
		List<PostComment> allPostCommentList = allPostComments.getPostComments();
		allPostCommentList.set(allPostCommentList.indexOf(oldPostComment), newPostComment);
	}
}
